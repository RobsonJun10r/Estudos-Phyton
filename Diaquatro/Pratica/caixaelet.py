...
if valor_saque <= 0:
    ...
    if valor_saque != 0:
        print("Não foi possível sacar o valor especificado com as cédulas disponíveis")
    else:
        print("Cedulas entregues: ")
        if cedulas_100 > 0:
            print(f"{cedulas_100} x R$100")
        if cedulas_50 > 0:
            print(f"{cedulas_100} x R$50")
        if cedulas_20 > 0:
            print(f"{cedulas_100} x R$20")
        if cedulas_10> 0:
            print(f"{cedulas_100} x R$10")
        if cedulas_5> 0:
            print(f"{cedulas_100} x R$5")
        if cedulas_2> 0:
            print(f"{cedulas_100} x R$2")